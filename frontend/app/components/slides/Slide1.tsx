...
export default function Slide1({ onEnter, centerContent }: Slide1Props) {
  const content = centerContent ?? (
    <motion.button
      onClick={onEnter}
      className="w-fit h-fit px-8 py-2.5 rounded-full font-semibold text-white text-sm transition-transform"
  ...
  return (
    ...
    >
      ...
      <div className="relative z-10 flex w-full items-center justify-center gap-6 px-8 md:px-12">
        <motion.img
          ...
          style={{
            ...
            filter: "drop-shadow(0 0 22px rgba(255, 240, 236, 0.72))",
          }}
        ...
        <motion.div
          ...
          style={{ width: "clamp(180px, 26vw, 360px)" }}
        ...
        >
          ...
          <motion.div
            className="absolute inset-0 z-20 m-auto flex items-center justify-center px-6"
